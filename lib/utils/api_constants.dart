const String baserUrl = "https://developbssr.dsantrenkreatif.my.id";
...
const String getDataNsabahUrl = "$baserUrl/api/v1/cek_data_nasabah/";
const String getDistrictUrl = "$baserUrl/api/v1/get_kecamatan?limit=10&term=";
const String getVilageUrl = "$baserUrl/api/v1/get_kelurahan";
